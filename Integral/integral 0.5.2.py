...
class Ui_MainWindow(object):
    ...
    def Integral(self):
        if self.func(self)==False: #Проверка пустой строки для уравнения - три всплывающих окна (исправление проблем v. 0.5.2)
            return 0
        else:
            if self.int_boards()==False: #Проверка пустых строк для границ интеграла - тривсплывающих окна (исправление проблем v. 0.5.2)
                return 0
            else:
